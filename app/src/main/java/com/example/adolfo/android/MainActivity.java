...
public class MainActivity extends Activity implements SensorEventListener{
    ...
    ImageButton btnArriba, btnAbajo, btnDerecha, btnIzquierda, bRotar,bLuz,bSensor;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnArriba = (ImageButton) findViewById(R.id.bArriba);
    ...
    public void tocaBocina(View v) {
        MediaPlayer mp = MediaPlayer.create(this, R.raw.camion);
        mp.start();
    }

    public void pulsarLuces(View view){
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
       ...
       if(flag && sensorEvent.sensor.getType()==Sensor.TYPE_ACCELEROMETER){
           ...
           Double x, y, z;
           x = Double.parseDouble(sensorEvent.values[0]+"");
           y = Double.parseDouble(sensorEvent.values[1]+"");
           z = Double.parseDouble(sensorEvent.values[2]+"");


           if((x <=6 && x >= 0) && (y > -5 && y < 5) && (z > 0 && z < 20)){
               mConnectedThread.write("U");
           }
           if((x <=6 && x >= 4) && (y > 0 && y < 8) && (z > 0 && z < 20)){
               mConnectedThread.write("D");
           }
           if((x <=6 && x >= 4) && (y > -9 && y < 0) && (z > 0 && z < 20)){
               mConnectedThread.write("I");
           }
           if((x <=9 && x >= 6.5) && (y > -5 && y < 5) && (z > 0 && z < 20)){
               mConnectedThread.write("A");
           }
